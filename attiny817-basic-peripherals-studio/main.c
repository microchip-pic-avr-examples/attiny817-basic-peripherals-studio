...
const uint32_t measure_cycles = 655360 / 8;
const uint32_t drive_cycles   = 655360 / 8;
const uint32_t display_cycles = 655360 / 2;
const uint32_t process_cycles = 655360 / 8;
const uint32_t clock1_cycles  = 655360;
const uint32_t clock2_cycles  = 655360 * 2;
...
static absolutetime_t measure()
{
	// Get conversion from ADC CH3/0 (Tiny817 ch3:PA3, 328pb ch0: PC0)
	measurement = ADC_0_get_conversion(3);
...
static absolutetime_t drive()
{
	...
	// Output duty cycle on PWM CH0(Tiny817:PB0, 328pb:PD6) as read from ADC
